...
def eg3_multi_query():
    ...
    for query in files:
        ...
        res.append(exp.run_experiment()[:2])
...
def variating_k():
    ...
    for i in range(1,5):
        ...
        ut.update_json("thresh_parameters.json", "num_hashes", hashes)
        res[hashes]=eg3_multi_query()
    ut.update_json("thresh_parameters.json", "num_hashes", 100)
    return res
...
if __name__=="__main__":
    plot_results(variating_k(), ["recall","average ratio"], 
                 output_file="results/threshold_experiment/variating_k.png")
